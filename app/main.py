...
def main():
    ...
    option = st.sidebar.selectbox('Selecciona una opción:', ['Encuesta de Satisfacción', 'Acceso a Datos'])

    if option == 'Encuesta de Satisfacción':
        # Tu código de encuesta de satisfacción aquí
    ...
    elif option == 'Acceso a Datos':
        # Mostrar la página de administración
        admin.data_access()  # Asegúrate de que esta función está definida en admin.py
